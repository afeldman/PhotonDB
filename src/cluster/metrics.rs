...
lazy_static::lazy_static! {
    ...
    pub static ref CONNECTION_ERRORS: IntCounterVec = IntCounterVec::new(
        Opts::new("rethinkdb_connection_errors_total", "Total connection errors"),
        &["reason"]
    ).unwrap();
...
mod tests {
    ...
    async fn test_record_query() {
        ...
        assert!(metrics.contains("rethinkdb_queries_total"));
    }
